...
/* ======================================== */
/* === CODE MỚI THÊM VÀO CHO LIGHTBOX === */
/* ======================================== */
...
for (var i = 0; i < images.length; i++) {
	images[i].onclick = function () {
		modal.style.display = "block"; // Hiển thị hộp đèn
		modalImg.src = this.src;       // Gán link ảnh được bấm vào hộp đèn
	}
}

// Khi người dùng bấm vào nút (x)
span.onclick = function () {
	modal.style.display = "none";
}

// Khi người dùng bấm vào nền đen, cũng đóng hộp đèn
