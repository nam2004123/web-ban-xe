            				...
            				<div class="image">
            					<div class="pro-info">
            						...
            						<form action="product.php?product_id='.$row['id'].'" method="post">
            						   <button class="add-to-cart" type="submit" name="add-to-cart-product"> Thêm vào giỏ</button>
            				...
            				<div class="image">
            					<div class="pro-info">
            						...
            						<form action="product.php?id='.$row['id'].'" method="post">
            						   <button class="add-to-cart" type="submit" name="add-to-cart"> Thêm vào giỏ</button>
            						   <button type="button" class="call"><i class="fas fa-phone"></i></button>
            						   <button type="button" class="mail"><i class="fas fa-envelope"></i></button>
            						</form>
            					</div>
