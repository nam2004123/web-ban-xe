...
<html lang="en" dir="ltr">
    ...
    if(isset($_SESSION['username'])){
        echo '<div class="profile">';
            ...
            if($_SESSION['admin'] == 1){
                // === NẾU LÀ ADMIN ===
                // Chỉ hiển thị cửa vào trang Admin
            ...
            // Nút Logout hiển thị cho cả hai
...
?>
				...
				<nav>
					<ul>
						<li class="to-home">TRANG CHỦ</li>
						<li class="to-login">ĐĂNG NHẬP</li>
						<li class="to-stories">CÂU CHUYỆN</li>
						<li class="to-cars">XE CỘ</li>
						<li class="to-my-thoughts">BÀI VIẾT</li>
						<li class="to-gallary">THƯ VIỆN</li>
					</ul>
				</nav>
			</header>
		</section>
		...
		<section id="login" class="showcase">
			<div class="showcase-text" data-aos="slide-up">
				...
				<div class="login-signup">
					<h4 class="login active-form">Đăng nhập</h4>
					<h4 class="signup">Đăng ký</h4>
				</div>
				<div class="forms">
					<form class="login-form" action="index.php" method="post">
						<input type="email" name="email" placeholder="Email"> <br>
                        <input type="password" name="password" placeholder="Mật khẩu"> <br>
                        <button type="submit" name="login-submit"> Đăng nhập </button>
					</form>
					<form class="signup-form" action="index.php" method="post">
						<input type="text" name="username" placeholder="Tên người dùng"> <br>
                        <input type="email" name="email" placeholder="Email"> <br>
                        <input type="password" name="password" placeholder="Mật khẩu"> <br>
                        <input type="password" name="re-password" placeholder="Nhập lại mật khẩu"> <br>
                        <button type="submit" name="signup-submit"> Đăng ký </button>
					</form>
				</div>
				<h1> CHINH PHỤC MỌI CUNG ĐƯỜNG</h1>
				<p>Dù nó nhắm đến sự tự do thì cũng chẳng có gì trang trí ngoài sự mềm mại.</p>
			</div>
		...
		<section class="stories">
			<h1 data-aos="slide-down">CÂU CHUYỆN</h1>
		...
		<section class="cars">
			<h1> XE </h1>
			<h4 class="regular  active-cars">XE PHỔ THÔNG</h4>
			<h4 class="sports">XE THỂ THAO</h4>
			<h4 class="off-road">XE ĐỊA HÌNH</h4>
            <div class="search-car">
                <form class="search-regular-car-form" action="more.php" method="post" onsubmit="add()">
                    <input class="search" type="text" name="regular-search" placeholder="Tìm kiếm">
			...
			<div class="cars-container1">
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=Regular"><i class="fas fa-angle-double-right"><span>Xem thêm</span> </i></a>
                </div>
			</div>
			<div class="cars-container2">
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=Sports"><i class="fas fa-angle-double-right"><span>Xem thêm</span> </i></a>
                </div>
			</div>
			<div class="cars-container3">
                ...
                <div class="more">
                    <a class="more-btn" href="more.php?type=all_cars"><i class="fas fa-angle-double-right"><span>Xem thêm</span> </i></a>
                </div>
		</section>
		...
		<section class="my-thoughts">
			<div class="my-thoughts-container">
                ...
                <?php
                    $i = 0;
                    foreach($thoughts as $row){ // $thoughts đã là một array (đã đảo ngược)
                        if($i > 4) break;
                ...
                <div class="more" style="text-align: center;">
                    <a class="more-btn" href="more.php?post=all_post"><i class="fas fa-angle-double-right"><span>Xem thêm</span> </i></a>
                </div>
			</div>
		</section>
		...
		<section class="gallary">
			...
			<div class="gallary-img">
                <?php
                    // === SỬA LỖI: Phục hồi logic PHP gốc ===
                    // $gallaries là biến từ index.inc.php, $row là biến mới
                    $row = $gallaries->fetch_assoc(); 
                    if (isset($row)) { // Kiểm tra xem $row có dữ liệu không
                        echo '<div class="row">
                             <div class="column">
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image1'].'" style="width:100%; height:200px;">
                                 </div>
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image2'].'" style="width:100%; height:200px;">
                                 </div>
                             </div>
                             <div class="column">
                                 <div class="overlay-port">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image3'].'" style="width:100%; height:407px;">
                                 </div>
                             </div>
                             <div class="column">
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image4'].'" style="width:100%; height:200px;">
                                 </div>
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image5'].'" style="width:100%; height:200px;">
                                 </div>
                             </div>
                             <div class="column">
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image6'].'" style="width:100%;height:200px;">
                                 </div>
                                 <div class="overlay">
                                     <h4>Bấm để xem toàn màn hình</h4>
                                     <img class="gallery-image" src="assets/Gallary_images/'.$row['image7'].'" style="width:100%; height:200px;">
                                 </div>
                             </div>
                            </div>';
                    }
